import { Directive, ElementRef, HostListener, Input, Output, EventEmitter,
    OnInit, HostBinding, Renderer2, NgZone, OnDestroy } from '@angular/core';
import { DomHelper } from '../Directives/dom-helper';
